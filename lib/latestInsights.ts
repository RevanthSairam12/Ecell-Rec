const insights = [
  {
    id: 1,
    image: "/eventposters/innv2startup.jpeg",
    ...
    id: 2,
    image: "/eventposters/schl2startup.png",
  ...
  },
  {
    ...
    id: 5,
    image: "/eventposters/youngprenuerFest.png",
    ...
    id: 6,
    image: "/eventposters/hackverse.jpg",
    title: "Hackverse 1.0",
    description: "Hackverse 1.0 was the first-ever state-wide 24-hour hackathon hosted by Raghu Engineering College, organized by E-CELL REC Visakhapatnam and GDG On Campus REC. The event brought together over 400 innovators who turned ideas into working prototypes in domains like AI, web, mobile, and automation. Students experienced the thrill of building, collaborating, and pitching under real-world pressure, guided by expert mentors and judged by an esteemed jury. It was a celebration of creativity, teamwork, and the spirit of innovation that defined the next generation of builders at REC.",
    date: "October 18-19, 2025",
    href: "/hackverse"
  }, {
    id: 7,
    image: "/eventposters/illuminate.png",
