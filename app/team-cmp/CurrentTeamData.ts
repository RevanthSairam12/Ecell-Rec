...
const CurrentTeamMembers = [
  {
    ...
    socialLinks: [
      { platform: 'Twitter', url: 'https://x.com/vishale1820?s=21&t=cirn4fQ-h3qu7URsa060cg' },
  ...
  },
  {
    ...
    socialLinks: [
      { platform: 'Twitter', url: 'https://x.com/aamuktha89755' },
      { platform: 'LinkedIn', url: 'https://www.linkedin.com/in/aamuktha-malyadha-b29659316/' },
    ],
  ...
  },
  {
    ...
    socialLinks: [
      { platform: 'Twitter', url: '#' },
      { platform: 'LinkedIn', url: 'https://www.linkedin.com/in/revanth-gudimetla-9a2565280/' },
    ],
