...
const AdminCalendar = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-amber-900 dark:via-orange-900 dark:to-red-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {/* Vintage View Toggle */}
              <div className="hidden sm:flex bg-amber-700/50 backdrop-blur-sm rounded-xl p-1 border-2 border-amber-500">
                <button
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                <Button 
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-green-400 font-bold text-xs sm:text-sm"
                >
                ...
                <Button 
                  onClick={() => window.location.href = '/calendar'}
                  className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-blue-400 font-bold text-xs sm:text-sm"
                >
      ...
      <div
        ref={sidebarRef}
        className={`fixed z-50 top-0 left-0 h-full w-72 bg-amber-800 border-r border-amber-600 transition-transform duration-300
      ...
      >
        ...
        <div className="flex justify-end p-2">
          <button aria-label="Close sidebar" onClick={() => setSidebarOpen(false)} className="text-amber-200">
            <X className="h-6 w-6" />
          </button>
        </div>
        <div className="p-4 sm:p-6 flex flex-col">
          ...
          <div className="flex items-center space-x-3 mb-4 lg:mb-8">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Admin Calendar</h1>
              <p className="text-amber-200 text-xs sm:text-sm">Manage Events</p>
            </div>
          </div>
          ...
          <div className="mb-4 lg:mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-amber-700 border border-amber-600 rounded-lg text-white placeholder-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm"
              />
            </div>
          </div>
          ...
          <div className="mb-4 lg:mb-6">
            <div className="flex items-center space-x-2 mb-2 sm:mb-3">
              ...
              <span className="text-xs sm:text-sm font-medium text-amber-200">Filter</span>
            </div>
          ...
          {/* Upcoming Events */}
          <div className="mb-4 lg:mb-6">
            <h3 className="text-xs sm:text-sm font-medium text-amber-200 mb-2 sm:mb-3">Upcoming Events</h3>
            <div className="space-y-2 max-h-40 sm:max-h-64 overflow-y-auto">
              {filteredEvents
                ...
                .map(event => (
                  <div
                    key={event.id}
                    className="p-2 sm:p-3 bg-amber-700 rounded-lg cursor-pointer hover:bg-amber-600 transition-colors"
                    onClick={() => {
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs sm:text-sm font-medium truncate text-white">{event.title}</span>
                      <div className="w-2 h-2 rounded-full" style={{ backgroundColor: event.color }}></div>
                    </div>
                    <div className="flex items-center space-x-2 text-[10px] sm:text-xs text-amber-300">
      ...
      <div className="fixed top-4 left-4 z-50 flex items-center lg:hidden">
        <button
          ...
          className="text-amber-200 focus:outline-none bg-amber-800 rounded-lg p-2 shadow-lg border border-amber-600"
        ...
        <span className="ml-3 text-lg font-bold text-white">Admin Calendar</span>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-7 gap-1 sm:gap-3 mb-4 sm:mb-6">
          {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
            <div key={day} className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-800 dark:to-orange-800 backdrop-blur-sm p-2 sm:p-4 text-center rounded-xl border-2 border-amber-300 dark:border-amber-600 shadow-lg">
              <span className="text-sm sm:text-lg font-bold text-amber-800 dark:text-amber-200 font-serif">
                {day}
              </span>
            </div>
          ))}
        ...
        <div className="grid grid-cols-7 gap-1 sm:gap-3">
          {days.map((day, index) => {
            ...
            return (
              <div
                key={index}
                className={`min-h-[120px] sm:min-h-[160px] bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-800 dark:to-orange-800 backdrop-blur-sm p-2 sm:p-4 rounded-xl border-2 border-amber-200 dark:border-amber-700 shadow-lg hover:shadow-xl transition-all duration-300 relative group ${
