        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 mt-8 md:mt-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto" style={{ fontFamily: '"Lato", system-ui, sans-serif', fontWeight: 400 }}>
              Your comprehensive roadmap from idea to successful startup
            </p>

            {/* Tags */}
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full border border-indigo-200">🎯 First-time Founders</span>
              <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full border border-indigo-200">🚀 Solo Entrepreneurs</span>
              <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full border border-indigo-200">💼 Early-stage Startups</span>
            </div>
          </div>
        </div>
      </section>
