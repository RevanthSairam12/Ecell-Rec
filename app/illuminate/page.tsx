  ...
  return (
    <div>
      ...
      <PageHero
        title="Illuminate"
        highlight="Workshop"
        description="Illuminate is a workshop designed to spark clarity in thought and confidence in action. It guides participants to see beyond limitations, question assumptions, and unlock new ways of thinking turning awareness into intentional growth."
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              A workshop designed to spark clarity in thought and confidence in action. It guides participants to see beyond limitations, question assumptions, and unlock new ways of thinking—turning awareness into intentional growth.
            </p>
          </div>
