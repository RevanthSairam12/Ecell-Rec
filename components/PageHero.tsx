...
const PageHero = ({ title, highlight, description, useWhiteBackground = false, children, showButtons = true }: PageHeroProps) => {
  return (
    <section className="hero relative">
      {/* Hero Slider */}
      <div className="relative w-full min-h-screen overflow-hidden">
        {/* White Background */}
        <div className={`absolute inset-0 ${useWhiteBackground ? 'bg-white' : 'bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/40'}`}></div>
